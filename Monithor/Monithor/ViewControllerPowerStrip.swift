...
class ViewControllerPowerStrip: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.tableViewPowerStrip.backgroundColor = UIColor(red: 245/255, green: 254/255, blue: 247/255, alpha: 1.0)
        self.tableViewPowerStrip.tableFooterView = UIView()
        self.tableViewPowerStrip.tableHeaderView = UIView()
